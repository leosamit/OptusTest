...
This application is developed for Optus Code Challenge purpose only which consists of three screens. The api used in this app is provided by Jsonplaceholder.
